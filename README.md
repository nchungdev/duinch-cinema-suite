...
- `duinch-cinema/backend`: API phục vụ duinch-cinema, tích hợp logic tìm kiếm và điều phối.
...
- **Environment:** Sử dụng `start_all.sh` để chạy môi trường phát triển local.
